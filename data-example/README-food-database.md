...
**Database Files**:
- `data-example/food-database.json` - Food nutrition database
...
1. **Open file**: `data-example/food-database.json`
2. **Update metadata**:
   ```json
   "metadata": {
...
1. **JSON Format Errors**:
   - Validate using a tool: `jq . data-example/food-database.json`
