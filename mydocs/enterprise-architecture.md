...
> **Evolution plan:** For the proposed v2 platform-first architecture (learning loop, Open WebUI, AG-UI), see **[platform-architecture-v2.md](platform-architecture-v2.md)**.  
> This document remains the detailed reference for compliance, FHIR mapping, anonymization, and deployment topology.
